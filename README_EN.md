...
From Terminal, inside the extracted `vesper` folder:
...
Run the `chmod +x` command from Quick start. If macOS blocks the downloaded file, open it once with **Control-click → Open**.
</details>
